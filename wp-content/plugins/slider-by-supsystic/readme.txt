...
* [Video Slider](http://supsystic.com/video-slider-example/ "WordPress Video Slider")
* [Post Feed Slider](http://supsystic.com/post-feed-example/ "Post Feed Slider")
* Content Slider
* [Thumbnails Slider](http://supsystic.com/thumbnails-pro-example/ "Thumbnails Slider")
* [Carousel Slider](http://supsystic.com/post-feed-carousel-example/ "WordPress Carousel Slider")
* Easy to use slider builder interface
* Add Slider with Shortcode
* Set image captions and links
* [HTML Layer Slideshow](http://supsystic.com/html-support-example/ "HTML Layer Slider")
...
You have an incredible opportunity to get PRO version of the Slider plguin for FREE. All you need is to make translation of the slider plugin! It will be amazing if you take advantage of this offer!
...
Thank you for choosing Slider by Supsystic! Open page of our plug-in admin panel WordPress and you will see three menu items: "New Slider", "Sliders" and "Settings".
...
= 1.5.5 = 23/03/2016
 * Fix of captions displaying for Jssor slider
 * Fix of captions displaying for Bx slider
 * Small code fix
 ...
 * Fix of encoding/decoding a special chars in the slider title
 * Fix of the search field work for adding images from wordpress media library
...
= 1.4.9 = 17/11/2015
 * Minor issues bug fix

= 1.4.8 = 14/10/2015
 * Fixed crop position bug
 * Minor issues bug fix
...
= 1.4.2 = 01/09/2015
 * Hot fix for 1.4.1 version release
...
= 1.3.8 = 11/08/2015
 * Fix Bx & Coin loader (visibility changes from hidden to visible)
 ...
 * Modify Html Jssor caption markup for middle vertical alignment
 ...
 * Facebook session check changed
 * Fixed stats error
 ...
 * List layout fixed
 * Social back buttons & breadcrumbs, menu anti-duplicate fix
 * Scroll fixed
 * Changes in appearance
 * Breadcrumbs fixed, trying to pass slider as parameter
 * Added corporate design
 ...
 * Animated caption under slider added
 * Translation fixed
 ...
 * Standard shortcode layout changed
 * Arrows and Bullets navigation settings was moved to dialog
 * Functional changes
