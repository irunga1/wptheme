...
(function ($, WordPress, undefined) {
    ...
    $(document).ready(function () {
        ...
        Controller.prototype.lastPostToggle = function(argument) {
            $table = $('#auto-posts').closest('table');

            $('#auto-posts-enable').on('change', function () {
                $table.find('tbody').show();
                $('.post-and-pages').not('.empty').hide();
                $('.post-and-pages-select').hide();
            });

            $('#auto-posts-disable').on('change', function () {
                $table.find('tbody').hide();
                $('.post-and-pages').not('.empty').show();
                $('.post-and-pages-select').show();
            });

            $table.find('thead input[type="radio"]:checked').iCheck('update').trigger('change');
        }
