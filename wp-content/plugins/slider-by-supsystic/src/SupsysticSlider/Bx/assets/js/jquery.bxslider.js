	...
	$.fn.bxSlider = function(options){
		...
		var setup = function(){
			...
			if(!slider.settings.ticker){
				...
				//if auto is false, and slideshowControls is true
				if(!slider.settings.auto && slider.settings.slideshowControls == 'enable') appendControlsAuto();
		...
		var appendCaptions = function(){
			...
			slider.children.each(function(index){
				...
				,	title = image.length ? image.attr('title') : $(this).attr('title');
				// append the caption
